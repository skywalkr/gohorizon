...
// checks if the ADUserInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADUserInfo{}
...
func (o ADUserInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Domain) {
		toSerialize["domain"] = o.Domain
	}
	if !IsNil(o.GroupGuids) {
