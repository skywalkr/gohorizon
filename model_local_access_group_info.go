...
// checks if the LocalAccessGroupInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalAccessGroupInfo{}
...
func (o LocalAccessGroupInfo) ToMap() (map[string]interface{}, error) {
