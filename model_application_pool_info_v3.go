...
// checks if the ApplicationPoolInfoV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationPoolInfoV3{}
...
func (o ApplicationPoolInfoV3) ToMap() (map[string]interface{}, error) {
