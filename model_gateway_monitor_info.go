...
// checks if the GatewayMonitorInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayMonitorInfo{}
...
func (o GatewayMonitorInfo) ToMap() (map[string]interface{}, error) {
