...
// checks if the FarmInfoV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmInfoV4{}

// FarmInfoV4 Information related to Farm.<br>List API returning this information can use search filter query to filter on specific fields supported by filters.<br>Supported Filters: 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
type FarmInfoV4 struct {
...
func (o FarmInfoV4) MarshalJSON() ([]byte, error) {
...
func (o FarmInfoV4) ToMap() (map[string]interface{}, error) {
...
type NullableFarmInfoV4 struct {
	value *FarmInfoV4
	isSet bool
}

func (v NullableFarmInfoV4) Get() *FarmInfoV4 {
	return v.value
}

func (v *NullableFarmInfoV4) Set(val *FarmInfoV4) {
	v.value = val
	v.isSet = true
}

func (v NullableFarmInfoV4) IsSet() bool {
	return v.isSet
}

func (v *NullableFarmInfoV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFarmInfoV4(val *FarmInfoV4) *NullableFarmInfoV4 {
	return &NullableFarmInfoV4{value: val, isSet: true}
}

func (v NullableFarmInfoV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFarmInfoV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
