...
// checks if the FarmAutomatedSettingsCreateSpecV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmAutomatedSettingsCreateSpecV2{}
...
type _FarmAutomatedSettingsCreateSpecV2 FarmAutomatedSettingsCreateSpecV2
...
func (o FarmAutomatedSettingsCreateSpecV2) ToMap() (map[string]interface{}, error) {
...
func (o *FarmAutomatedSettingsCreateSpecV2) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmAutomatedSettingsCreateSpecV2 := _FarmAutomatedSettingsCreateSpecV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmAutomatedSettingsCreateSpecV2)

	if err != nil {
		return err
	}

	*o = FarmAutomatedSettingsCreateSpecV2(varFarmAutomatedSettingsCreateSpecV2)
