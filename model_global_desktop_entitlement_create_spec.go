...
// checks if the GlobalDesktopEntitlementCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalDesktopEntitlementCreateSpec{}
...
type _GlobalDesktopEntitlementCreateSpec GlobalDesktopEntitlementCreateSpec
...
func (o GlobalDesktopEntitlementCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *GlobalDesktopEntitlementCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalDesktopEntitlementCreateSpec := _GlobalDesktopEntitlementCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGlobalDesktopEntitlementCreateSpec)

	if err != nil {
		return err
	}

	*o = GlobalDesktopEntitlementCreateSpec(varGlobalDesktopEntitlementCreateSpec)
