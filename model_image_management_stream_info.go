...
// checks if the ImageManagementStreamInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageManagementStreamInfo{}
...
func (o ImageManagementStreamInfo) ToMap() (map[string]interface{}, error) {
