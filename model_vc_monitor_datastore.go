...
// checks if the VCMonitorDatastore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VCMonitorDatastore{}
...
func (o VCMonitorDatastore) ToMap() (map[string]interface{}, error) {
