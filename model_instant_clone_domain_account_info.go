...
// checks if the InstantCloneDomainAccountInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstantCloneDomainAccountInfo{}
...
func (o InstantCloneDomainAccountInfo) ToMap() (map[string]interface{}, error) {
