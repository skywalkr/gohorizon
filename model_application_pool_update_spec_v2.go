...
// checks if the ApplicationPoolUpdateSpecV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationPoolUpdateSpecV2{}
...
type _ApplicationPoolUpdateSpecV2 ApplicationPoolUpdateSpecV2
...
func (o ApplicationPoolUpdateSpecV2) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationPoolUpdateSpecV2) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationPoolUpdateSpecV2 := _ApplicationPoolUpdateSpecV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicationPoolUpdateSpecV2)

	if err != nil {
		return err
	}

	*o = ApplicationPoolUpdateSpecV2(varApplicationPoolUpdateSpecV2)
