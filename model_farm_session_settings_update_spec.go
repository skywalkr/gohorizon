...
// checks if the FarmSessionSettingsUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmSessionSettingsUpdateSpec{}
...
type _FarmSessionSettingsUpdateSpec FarmSessionSettingsUpdateSpec
...
func (o FarmSessionSettingsUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *FarmSessionSettingsUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmSessionSettingsUpdateSpec := _FarmSessionSettingsUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmSessionSettingsUpdateSpec)

	if err != nil {
		return err
	}

	*o = FarmSessionSettingsUpdateSpec(varFarmSessionSettingsUpdateSpec)
