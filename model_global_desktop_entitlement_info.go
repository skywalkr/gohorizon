...
// checks if the GlobalDesktopEntitlementInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalDesktopEntitlementInfo{}
...
func (o GlobalDesktopEntitlementInfo) ToMap() (map[string]interface{}, error) {
