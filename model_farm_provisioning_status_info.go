...
// checks if the FarmProvisioningStatusInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmProvisioningStatusInfo{}
...
func (o FarmProvisioningStatusInfo) ToMap() (map[string]interface{}, error) {
