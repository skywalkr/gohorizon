...
// checks if the DesktopPoolInfoV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolInfoV3{}

// DesktopPoolInfoV3 Information related to Desktop Pool.<br>List API returning this information can use search filter query to filter on specific fields supported by filters.<br>Supported Filters: 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
type DesktopPoolInfoV3 struct {
...
func (o DesktopPoolInfoV3) MarshalJSON() ([]byte, error) {
...
func (o DesktopPoolInfoV3) ToMap() (map[string]interface{}, error) {
...
type NullableDesktopPoolInfoV3 struct {
	value *DesktopPoolInfoV3
	isSet bool
}

func (v NullableDesktopPoolInfoV3) Get() *DesktopPoolInfoV3 {
	return v.value
}

func (v *NullableDesktopPoolInfoV3) Set(val *DesktopPoolInfoV3) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopPoolInfoV3) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopPoolInfoV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopPoolInfoV3(val *DesktopPoolInfoV3) *NullableDesktopPoolInfoV3 {
	return &NullableDesktopPoolInfoV3{value: val, isSet: true}
}

func (v NullableDesktopPoolInfoV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopPoolInfoV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
