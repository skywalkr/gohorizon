...
// checks if the FarmAutomatedSettingsUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmAutomatedSettingsUpdateSpec{}
...
type _FarmAutomatedSettingsUpdateSpec FarmAutomatedSettingsUpdateSpec
...
func (o FarmAutomatedSettingsUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *FarmAutomatedSettingsUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmAutomatedSettingsUpdateSpec := _FarmAutomatedSettingsUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmAutomatedSettingsUpdateSpec)

	if err != nil {
		return err
	}

	*o = FarmAutomatedSettingsUpdateSpec(varFarmAutomatedSettingsUpdateSpec)
