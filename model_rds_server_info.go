...
// checks if the RDSServerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RDSServerInfo{}
...
type RDSServerInfo struct {
	...
	// The current maintenance operation on the RDS Server.<br>Supported Filters : 'Equals'. * PUSH_IMAGE: A push image operation. * ARCHIVE: An archive operation. * TAGGING: A tagging operation.
	Operation *string `json:"operation,omitempty"`
	// The state of the current maintenance operation on the RDS Server.<br>Supported Filters : 'Equals'. * UNDEFINED: The operation state is unrecognized. * SCHEDULED: The operation is scheduled for future execution. * PROGRESSING: The operation is in progress. * COMPLETED: The operation has completed. * FAULT: The operation has encountered an error. * CANCELLING: The operation has been cancelled. * HOLDING: The operation has been paused. * CREATE: The operation is being initiated. * STANDBY: The operation is on standby for a selective resync.
...
func (o *RDSServerInfo) GetLoadPreference() string {
	if o == nil || IsNil(o.LoadPreference) {
		var ret string
		return ret
	}
...
func (o *RDSServerInfo) GetMaxSessionsCount() int32 {
	if o == nil || IsNil(o.MaxSessionsCount) {
		var ret int32
		return ret
	}
...
func (o *RDSServerInfo) GetMaxSessionsType() string {
	if o == nil || IsNil(o.MaxSessionsType) {
		var ret string
		return ret
	}
...
func (o *RDSServerInfo) GetMaxSessionsTypeConfigured() string {
	if o == nil || IsNil(o.MaxSessionsTypeConfigured) {
		var ret string
		return ret
	}
...
func (o RDSServerInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaxSessionsType) {
		toSerialize["max_sessions_type"] = o.MaxSessionsType
	}
	if !IsNil(o.MaxSessionsTypeConfigured) {
