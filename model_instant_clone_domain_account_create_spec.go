...
// checks if the InstantCloneDomainAccountCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstantCloneDomainAccountCreateSpec{}
...
type _InstantCloneDomainAccountCreateSpec InstantCloneDomainAccountCreateSpec
...
func (o InstantCloneDomainAccountCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *InstantCloneDomainAccountCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varInstantCloneDomainAccountCreateSpec := _InstantCloneDomainAccountCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInstantCloneDomainAccountCreateSpec)

	if err != nil {
		return err
	}

	*o = InstantCloneDomainAccountCreateSpec(varInstantCloneDomainAccountCreateSpec)
