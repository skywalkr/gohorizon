...
// checks if the EntitlementResponseInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementResponseInfo{}

// EntitlementResponseInfo Entitlement response info object corresponding to the given ad-user-or-group SID for the entitlement operation.
...
func (o EntitlementResponseInfo) ToMap() (map[string]interface{}, error) {
