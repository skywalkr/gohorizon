...
// checks if the DesktopPoolInstantClonePushImageSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolInstantClonePushImageSettings{}
...
func (o DesktopPoolInstantClonePushImageSettings) ToMap() (map[string]interface{}, error) {
