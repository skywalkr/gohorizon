...
// checks if the InstalledApplicationInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstalledApplicationInfo{}
...
func (o InstalledApplicationInfo) ToMap() (map[string]interface{}, error) {
