...
**Id** | Pointer to **string** | Unique ID representing image management stream. | [optional] 
**Name** | Pointer to **string** | Image management stream name. | [optional] 
...
`func NewImageManagementStreamInfo() *ImageManagementStreamInfo`
...
`func (o *ImageManagementStreamInfo) HasId() bool`
...
`func (o *ImageManagementStreamInfo) HasName() bool`
...
`func (o *ImageManagementStreamInfo) HasOperatingSystem() bool`
...
`func (o *ImageManagementStreamInfo) HasSource() bool`
...
`func (o *ImageManagementStreamInfo) HasStatus() bool`
