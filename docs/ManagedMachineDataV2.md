...
**Operation** | Pointer to **string** | The current maintenance operation on the machine.&lt;br&gt;Supported Filters : &#39;Equals&#39;. * PUSH_IMAGE: A push image operation. * ARCHIVE: An archive operation. * TAGGING: A tagging operation. | [optional] 
