...
// checks if the RDSServerMonitorDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RDSServerMonitorDetails{}
...
func (o RDSServerMonitorDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AgentBuild) {
