...
// checks if the GatewayMonitorInfoV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayMonitorInfoV2{}
...
func (o GatewayMonitorInfoV2) ToMap() (map[string]interface{}, error) {
