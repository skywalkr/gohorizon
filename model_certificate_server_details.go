...
// checks if the CertificateServerDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateServerDetails{}
...
func (o CertificateServerDetails) ToMap() (map[string]interface{}, error) {
