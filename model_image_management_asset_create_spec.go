...
// checks if the ImageManagementAssetCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageManagementAssetCreateSpec{}
...
type _ImageManagementAssetCreateSpec ImageManagementAssetCreateSpec
...
func (o ImageManagementAssetCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *ImageManagementAssetCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varImageManagementAssetCreateSpec := _ImageManagementAssetCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageManagementAssetCreateSpec)

	if err != nil {
		return err
	}

	*o = ImageManagementAssetCreateSpec(varImageManagementAssetCreateSpec)
