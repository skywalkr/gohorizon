...
// checks if the FarmCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmCreateSpec{}
...
type _FarmCreateSpec FarmCreateSpec
...
func (o FarmCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *FarmCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmCreateSpec := _FarmCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmCreateSpec)

	if err != nil {
		return err
	}

	*o = FarmCreateSpec(varFarmCreateSpec)
