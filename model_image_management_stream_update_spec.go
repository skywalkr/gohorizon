...
// checks if the ImageManagementStreamUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageManagementStreamUpdateSpec{}
...
type _ImageManagementStreamUpdateSpec ImageManagementStreamUpdateSpec
...
func (o ImageManagementStreamUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *ImageManagementStreamUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varImageManagementStreamUpdateSpec := _ImageManagementStreamUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageManagementStreamUpdateSpec)

	if err != nil {
		return err
	}

	*o = ImageManagementStreamUpdateSpec(varImageManagementStreamUpdateSpec)
