...
// checks if the FarmCustomizationSettingsCreateSpecV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmCustomizationSettingsCreateSpecV2{}
...
type _FarmCustomizationSettingsCreateSpecV2 FarmCustomizationSettingsCreateSpecV2
...
func (o FarmCustomizationSettingsCreateSpecV2) ToMap() (map[string]interface{}, error) {
...
func (o *FarmCustomizationSettingsCreateSpecV2) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmCustomizationSettingsCreateSpecV2 := _FarmCustomizationSettingsCreateSpecV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmCustomizationSettingsCreateSpecV2)

	if err != nil {
		return err
	}

	*o = FarmCustomizationSettingsCreateSpecV2(varFarmCustomizationSettingsCreateSpecV2)
