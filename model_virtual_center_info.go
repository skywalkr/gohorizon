...
// checks if the VirtualCenterInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualCenterInfo{}
...
func (o *VirtualCenterInfo) GetVmcDeployment() bool {
	if o == nil || IsNil(o.VmcDeployment) {
		var ret bool
		return ret
	}
...
func (o VirtualCenterInfo) ToMap() (map[string]interface{}, error) {
