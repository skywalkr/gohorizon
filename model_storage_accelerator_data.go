...
// checks if the StorageAcceleratorData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageAcceleratorData{}
...
func (o *StorageAcceleratorData) GetDefaultCacheSizeMb() int32 {
	if o == nil || IsNil(o.DefaultCacheSizeMb) {
		var ret int32
		return ret
	}
...
func (o *StorageAcceleratorData) GetHostOverrides() []HostOverrideData {
	if o == nil || IsNil(o.HostOverrides) {
...
func (o StorageAcceleratorData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DefaultCacheSizeMb) {
		toSerialize["default_cache_size_mb"] = o.DefaultCacheSizeMb
	}
	if !IsNil(o.Enabled) {
		toSerialize["enabled"] = o.Enabled
	}
	if !IsNil(o.HostOverrides) {
