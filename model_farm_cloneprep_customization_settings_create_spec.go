...
// checks if the FarmCloneprepCustomizationSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmCloneprepCustomizationSettingsCreateSpec{}
...
func (o FarmCloneprepCustomizationSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
