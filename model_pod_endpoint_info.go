...
// checks if the PodEndpointInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PodEndpointInfo{}
...
func (o PodEndpointInfo) ToMap() (map[string]interface{}, error) {
