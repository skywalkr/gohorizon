...
// checks if the ADDomainMonitorConnectionServerV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADDomainMonitorConnectionServerV2{}
...
func (o ADDomainMonitorConnectionServerV2) ToMap() (map[string]interface{}, error) {
