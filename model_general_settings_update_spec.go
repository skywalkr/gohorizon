...
// checks if the GeneralSettingsUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeneralSettingsUpdateSpec{}
...
type _GeneralSettingsUpdateSpec GeneralSettingsUpdateSpec
...
func NewGeneralSettingsUpdateSpec(applicationSsoTimeoutPolicy string, clientIdleSessionTimeoutPolicy string, clientMaxSessionTimeoutPolicy string, clientSessionTimeoutMinutes int32, machineSsoTimeoutPolicy string, storeCalOnClient bool, storeCalOnConnectionServer bool) *GeneralSettingsUpdateSpec {
	this := GeneralSettingsUpdateSpec{}
...
func (o GeneralSettingsUpdateSpec) MarshalJSON() ([]byte, error) {
...
func (o GeneralSettingsUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *GeneralSettingsUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varGeneralSettingsUpdateSpec := _GeneralSettingsUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGeneralSettingsUpdateSpec)

	if err != nil {
		return err
	}

	*o = GeneralSettingsUpdateSpec(varGeneralSettingsUpdateSpec)

	return err
}

type NullableGeneralSettingsUpdateSpec struct {
	value *GeneralSettingsUpdateSpec
	isSet bool
}

func (v NullableGeneralSettingsUpdateSpec) Get() *GeneralSettingsUpdateSpec {
	return v.value
}

func (v *NullableGeneralSettingsUpdateSpec) Set(val *GeneralSettingsUpdateSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralSettingsUpdateSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralSettingsUpdateSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralSettingsUpdateSpec(val *GeneralSettingsUpdateSpec) *NullableGeneralSettingsUpdateSpec {
	return &NullableGeneralSettingsUpdateSpec{value: val, isSet: true}
}

func (v NullableGeneralSettingsUpdateSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralSettingsUpdateSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
