...
// checks if the CertificateOverrideData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateOverrideData{}
...
func (o CertificateOverrideData) ToMap() (map[string]interface{}, error) {
