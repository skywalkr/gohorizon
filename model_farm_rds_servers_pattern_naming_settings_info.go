...
// checks if the FarmRDSServersPatternNamingSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmRDSServersPatternNamingSettingsInfo{}
...
func (o FarmRDSServersPatternNamingSettingsInfo) ToMap() (map[string]interface{}, error) {
