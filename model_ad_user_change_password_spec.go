...
// checks if the ADUserChangePasswordSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADUserChangePasswordSpec{}
...
type _ADUserChangePasswordSpec ADUserChangePasswordSpec
...
func (o ADUserChangePasswordSpec) ToMap() (map[string]interface{}, error) {
...
func (o *ADUserChangePasswordSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varADUserChangePasswordSpec := _ADUserChangePasswordSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varADUserChangePasswordSpec)

	if err != nil {
		return err
	}

	*o = ADUserChangePasswordSpec(varADUserChangePasswordSpec)
