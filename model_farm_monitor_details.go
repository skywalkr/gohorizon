...
// checks if the FarmMonitorDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmMonitorDetails{}
...
func (o FarmMonitorDetails) ToMap() (map[string]interface{}, error) {
