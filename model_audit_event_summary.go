...
// checks if the AuditEventSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditEventSummary{}

// AuditEventSummary Information related to Audit Events.<br> Supported Filters : 'And', 'Or', 'Equals' and 'Between'.<br>See the field description to know the filter types it supports.
...
func (o *AuditEventSummary) GetApplicationPoolName() string {
	if o == nil || IsNil(o.ApplicationPoolName) {
		var ret string
		return ret
	}
...
func (o *AuditEventSummary) GetDesktopPoolName() string {
	if o == nil || IsNil(o.DesktopPoolName) {
		var ret string
		return ret
	}
...
func (o AuditEventSummary) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ApplicationPoolName) {
		toSerialize["application_pool_name"] = o.ApplicationPoolName
	}
	if !IsNil(o.DesktopPoolName) {
