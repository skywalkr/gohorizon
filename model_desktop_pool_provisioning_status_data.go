...
// checks if the DesktopPoolProvisioningStatusData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolProvisioningStatusData{}
...
func (o DesktopPoolProvisioningStatusData) ToMap() (map[string]interface{}, error) {
