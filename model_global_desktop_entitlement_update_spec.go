...
// checks if the GlobalDesktopEntitlementUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalDesktopEntitlementUpdateSpec{}
...
type _GlobalDesktopEntitlementUpdateSpec GlobalDesktopEntitlementUpdateSpec
...
func (o GlobalDesktopEntitlementUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *GlobalDesktopEntitlementUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalDesktopEntitlementUpdateSpec := _GlobalDesktopEntitlementUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGlobalDesktopEntitlementUpdateSpec)

	if err != nil {
		return err
	}

	*o = GlobalDesktopEntitlementUpdateSpec(varGlobalDesktopEntitlementUpdateSpec)
