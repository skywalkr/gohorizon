...
// checks if the DesktopPoolInfoV5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolInfoV5{}

// DesktopPoolInfoV5 Information related to Desktop Pool.<br>List API returning this information can use search filter query to filter on specific fields supported by filters.<br>Supported Filters: 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
type DesktopPoolInfoV5 struct {
...
func (o DesktopPoolInfoV5) MarshalJSON() ([]byte, error) {
...
func (o DesktopPoolInfoV5) ToMap() (map[string]interface{}, error) {
...
type NullableDesktopPoolInfoV5 struct {
	value *DesktopPoolInfoV5
	isSet bool
}

func (v NullableDesktopPoolInfoV5) Get() *DesktopPoolInfoV5 {
	return v.value
}

func (v *NullableDesktopPoolInfoV5) Set(val *DesktopPoolInfoV5) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopPoolInfoV5) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopPoolInfoV5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopPoolInfoV5(val *DesktopPoolInfoV5) *NullableDesktopPoolInfoV5 {
	return &NullableDesktopPoolInfoV5{value: val, isSet: true}
}

func (v NullableDesktopPoolInfoV5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopPoolInfoV5) UnmarshalJSON(src []byte) error {
	v.isSet = true
