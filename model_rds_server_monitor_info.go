...
// checks if the RDSServerMonitorInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RDSServerMonitorInfo{}
...
func (o RDSServerMonitorInfo) ToMap() (map[string]interface{}, error) {
