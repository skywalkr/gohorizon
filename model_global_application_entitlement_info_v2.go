...
// checks if the GlobalApplicationEntitlementInfoV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalApplicationEntitlementInfoV2{}
...
func (o *GlobalApplicationEntitlementInfoV2) GetApplicationIconIds() []string {
	if o == nil || IsNil(o.ApplicationIconIds) {
		var ret []string
		return ret
	}
...
func (o *GlobalApplicationEntitlementInfoV2) GetLocalApplicationPoolsCount() int32 {
	if o == nil || IsNil(o.LocalApplicationPoolsCount) {
		var ret int32
		return ret
	}
...
func (o *GlobalApplicationEntitlementInfoV2) GetRemoteApplicationPoolsCount() int32 {
	if o == nil || IsNil(o.RemoteApplicationPoolsCount) {
		var ret int32
		return ret
	}
...
func (o GlobalApplicationEntitlementInfoV2) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LocalApplicationPoolsCount) {
	...
	if !IsNil(o.PrimaryGaeId) {
		toSerialize["primary_gae_id"] = o.PrimaryGaeId
	}
	if !IsNil(o.RemoteApplicationPoolsCount) {
