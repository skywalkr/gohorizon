...
// checks if the BulkItemResponseInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkItemResponseInfo{}
...
func (o BulkItemResponseInfo) ToMap() (map[string]interface{}, error) {
