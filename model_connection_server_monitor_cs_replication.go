...
// checks if the ConnectionServerMonitorCSReplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionServerMonitorCSReplication{}
...
func (o ConnectionServerMonitorCSReplication) ToMap() (map[string]interface{}, error) {
