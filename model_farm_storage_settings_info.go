...
// checks if the FarmStorageSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmStorageSettingsInfo{}
...
func (o FarmStorageSettingsInfo) ToMap() (map[string]interface{}, error) {
