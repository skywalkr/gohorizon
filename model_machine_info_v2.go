...
// checks if the MachineInfoV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MachineInfoV2{}
...
func (o MachineInfoV2) ToMap() (map[string]interface{}, error) {
