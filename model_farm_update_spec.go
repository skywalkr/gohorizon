...
// checks if the FarmUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmUpdateSpec{}
...
type _FarmUpdateSpec FarmUpdateSpec
...
func (o FarmUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *FarmUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmUpdateSpec := _FarmUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmUpdateSpec)

	if err != nil {
		return err
	}

	*o = FarmUpdateSpec(varFarmUpdateSpec)
