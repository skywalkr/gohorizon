...
// checks if the VCMonitorDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VCMonitorDetails{}
...
func (o VCMonitorDetails) ToMap() (map[string]interface{}, error) {
