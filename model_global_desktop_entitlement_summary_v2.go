...
// checks if the GlobalDesktopEntitlementSummaryV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalDesktopEntitlementSummaryV2{}

// GlobalDesktopEntitlementSummaryV2 Summary Information about Global Desktop Entitlement. <br>Supported Filters : 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
type GlobalDesktopEntitlementSummaryV2 struct {
	...
	// This represents id of the federated access group associated with the global desktop entitlement.<br> Supported Filters: 'Equals'.
...
func NewGlobalDesktopEntitlementSummaryV2() *GlobalDesktopEntitlementSummaryV2 {
	this := GlobalDesktopEntitlementSummaryV2{}
	return &this
}
...
func (o GlobalDesktopEntitlementSummaryV2) MarshalJSON() ([]byte, error) {
...
func (o GlobalDesktopEntitlementSummaryV2) ToMap() (map[string]interface{}, error) {
...
type NullableGlobalDesktopEntitlementSummaryV2 struct {
	value *GlobalDesktopEntitlementSummaryV2
	isSet bool
}

func (v NullableGlobalDesktopEntitlementSummaryV2) Get() *GlobalDesktopEntitlementSummaryV2 {
	return v.value
}

func (v *NullableGlobalDesktopEntitlementSummaryV2) Set(val *GlobalDesktopEntitlementSummaryV2) {
	v.value = val
	v.isSet = true
}

func (v NullableGlobalDesktopEntitlementSummaryV2) IsSet() bool {
	return v.isSet
}

func (v *NullableGlobalDesktopEntitlementSummaryV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGlobalDesktopEntitlementSummaryV2(val *GlobalDesktopEntitlementSummaryV2) *NullableGlobalDesktopEntitlementSummaryV2 {
	return &NullableGlobalDesktopEntitlementSummaryV2{value: val, isSet: true}
}

func (v NullableGlobalDesktopEntitlementSummaryV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGlobalDesktopEntitlementSummaryV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
