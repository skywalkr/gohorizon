...
// checks if the DesktopPoolNetworkInterfaceCardSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolNetworkInterfaceCardSettings{}
...
func (o DesktopPoolNetworkInterfaceCardSettings) ToMap() (map[string]interface{}, error) {
