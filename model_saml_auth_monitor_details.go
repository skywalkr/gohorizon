...
// checks if the SAMLAuthMonitorDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SAMLAuthMonitorDetails{}
...
func (o SAMLAuthMonitorDetails) ToMap() (map[string]interface{}, error) {
