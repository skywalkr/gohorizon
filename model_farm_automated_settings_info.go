...
// checks if the FarmAutomatedSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmAutomatedSettingsInfo{}
...
func (o FarmAutomatedSettingsInfo) ToMap() (map[string]interface{}, error) {
