...
// checks if the FarmSessionSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmSessionSettingsInfo{}

// FarmSessionSettingsInfo Session settings related to the Farm.
type FarmSessionSettingsInfo struct {
...
func (o FarmSessionSettingsInfo) MarshalJSON() ([]byte, error) {
...
func (o FarmSessionSettingsInfo) ToMap() (map[string]interface{}, error) {
...
type NullableFarmSessionSettingsInfo struct {
	value *FarmSessionSettingsInfo
	isSet bool
}

func (v NullableFarmSessionSettingsInfo) Get() *FarmSessionSettingsInfo {
	return v.value
}

func (v *NullableFarmSessionSettingsInfo) Set(val *FarmSessionSettingsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableFarmSessionSettingsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableFarmSessionSettingsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFarmSessionSettingsInfo(val *FarmSessionSettingsInfo) *NullableFarmSessionSettingsInfo {
	return &NullableFarmSessionSettingsInfo{value: val, isSet: true}
}

func (v NullableFarmSessionSettingsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFarmSessionSettingsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
