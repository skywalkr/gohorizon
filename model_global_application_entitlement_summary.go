...
// checks if the GlobalApplicationEntitlementSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalApplicationEntitlementSummary{}

// GlobalApplicationEntitlementSummary Summary Information about Global Application Entitlement. <br>Supported Filters : 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
...
func (o GlobalApplicationEntitlementSummary) ToMap() (map[string]interface{}, error) {
