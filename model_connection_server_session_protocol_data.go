...
// checks if the ConnectionServerSessionProtocolData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionServerSessionProtocolData{}
...
func (o ConnectionServerSessionProtocolData) ToMap() (map[string]interface{}, error) {
