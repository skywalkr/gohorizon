...
// checks if the ApplicationPoolInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationPoolInfo{}
...
func (o ApplicationPoolInfo) MarshalJSON() ([]byte, error) {
...
func (o ApplicationPoolInfo) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationPoolInfo struct {
	value *ApplicationPoolInfo
	isSet bool
}

func (v NullableApplicationPoolInfo) Get() *ApplicationPoolInfo {
	return v.value
}

func (v *NullableApplicationPoolInfo) Set(val *ApplicationPoolInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationPoolInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationPoolInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationPoolInfo(val *ApplicationPoolInfo) *NullableApplicationPoolInfo {
	return &NullableApplicationPoolInfo{value: val, isSet: true}
}

func (v NullableApplicationPoolInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationPoolInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
