...
// checks if the NetworkInterfaceCardInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkInterfaceCardInfo{}
...
func (o NetworkInterfaceCardInfo) ToMap() (map[string]interface{}, error) {
