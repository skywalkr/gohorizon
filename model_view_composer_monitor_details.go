...
// checks if the ViewComposerMonitorDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewComposerMonitorDetails{}
...
func (o *ViewComposerMonitorDetails) GetMinEsxVersion() string {
	if o == nil || IsNil(o.MinEsxVersion) {
		var ret string
		return ret
	}
...
func (o *ViewComposerMonitorDetails) GetReferencedVcs() []string {
	if o == nil || IsNil(o.ReferencedVcs) {
		var ret []string
		return ret
	}
...
func (o ViewComposerMonitorDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ApiVerion) {
		toSerialize["api_verion"] = o.ApiVerion
	}
	if !IsNil(o.Build) {
		toSerialize["build"] = o.Build
	}
	if !IsNil(o.MinEsxVersion) {
		toSerialize["min_esx_version"] = o.MinEsxVersion
	}
	if !IsNil(o.MinVcVersion) {
		toSerialize["min_vc_version"] = o.MinVcVersion
	}
	if !IsNil(o.ReferencedVcs) {
