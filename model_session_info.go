...
// SessionInfo Information related to Session. <br>Supported Filters : 'And', 'Or', 'Equals', 'NotEquals' and 'Contains'.<br>See the field description to know the filter types it supports.
