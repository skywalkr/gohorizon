...
// checks if the DesktopPoolStorageSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolStorageSettings{}
...
func (o *DesktopPoolStorageSettings) GetNonPersistentDiskDriveLetter() string {
	if o == nil || IsNil(o.NonPersistentDiskDriveLetter) {
		var ret string
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetNonPersistentDiskSizeMb() int32 {
	if o == nil || IsNil(o.NonPersistentDiskSizeMb) {
		var ret int32
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetNonPersistentRedirectDisposableFiles() bool {
	if o == nil || IsNil(o.NonPersistentRedirectDisposableFiles) {
		var ret bool
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetPersistentDiskDatastores() []DesktopPoolDatastoreSettings {
	if o == nil || IsNil(o.PersistentDiskDatastores) {
		var ret []DesktopPoolDatastoreSettings
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetPersistentDiskDriveLetter() string {
	if o == nil || IsNil(o.PersistentDiskDriveLetter) {
		var ret string
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetPersistentDiskSizeMb() int32 {
	if o == nil || IsNil(o.PersistentDiskSizeMb) {
		var ret int32
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetRedirectWindowsProfile() bool {
	if o == nil || IsNil(o.RedirectWindowsProfile) {
		var ret bool
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetUseNativeSnapshots() bool {
	if o == nil || IsNil(o.UseNativeSnapshots) {
		var ret bool
		return ret
	}
...
func (o *DesktopPoolStorageSettings) GetUseSeparateDatastoresPersistentAndOsDisks() bool {
	if o == nil || IsNil(o.UseSeparateDatastoresPersistentAndOsDisks) {
		var ret bool
		return ret
	}
...
func (o DesktopPoolStorageSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RedirectWindowsProfile) {
	...
	if !IsNil(o.UseNativeSnapshots) {
		toSerialize["use_native_snapshots"] = o.UseNativeSnapshots
	}
	if !IsNil(o.UseSeparateDatastoresPersistentAndOsDisks) {
