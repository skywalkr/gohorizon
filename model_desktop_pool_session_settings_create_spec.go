...
// checks if the DesktopPoolSessionSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolSessionSettingsCreateSpec{}
...
func (o DesktopPoolSessionSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
