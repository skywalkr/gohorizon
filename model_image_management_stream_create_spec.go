...
// checks if the ImageManagementStreamCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageManagementStreamCreateSpec{}
...
type _ImageManagementStreamCreateSpec ImageManagementStreamCreateSpec
...
func (o ImageManagementStreamCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *ImageManagementStreamCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varImageManagementStreamCreateSpec := _ImageManagementStreamCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageManagementStreamCreateSpec)

	if err != nil {
		return err
	}

	*o = ImageManagementStreamCreateSpec(varImageManagementStreamCreateSpec)
