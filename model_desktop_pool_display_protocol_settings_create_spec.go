...
// checks if the DesktopPoolDisplayProtocolSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolDisplayProtocolSettingsCreateSpec{}
...
func (o DesktopPoolDisplayProtocolSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
