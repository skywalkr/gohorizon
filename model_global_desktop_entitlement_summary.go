...
// checks if the GlobalDesktopEntitlementSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalDesktopEntitlementSummary{}

// GlobalDesktopEntitlementSummary Summary Information about Global Desktop Entitlement. <br>Supported Filters : 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
...
func (o GlobalDesktopEntitlementSummary) ToMap() (map[string]interface{}, error) {
