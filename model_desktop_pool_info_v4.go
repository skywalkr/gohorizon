...
// checks if the DesktopPoolInfoV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolInfoV4{}
...
func (o DesktopPoolInfoV4) ToMap() (map[string]interface{}, error) {
