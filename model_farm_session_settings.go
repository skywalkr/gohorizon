...
// checks if the FarmSessionSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmSessionSettings{}
...
func (o FarmSessionSettings) ToMap() (map[string]interface{}, error) {
