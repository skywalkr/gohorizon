...
// checks if the RDSHLoadBalancerSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RDSHLoadBalancerSettingsInfo{}
...
func (o RDSHLoadBalancerSettingsInfo) ToMap() (map[string]interface{}, error) {
