...
// checks if the DesktopPoolStorageSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolStorageSettingsCreateSpec{}
...
type _DesktopPoolStorageSettingsCreateSpec DesktopPoolStorageSettingsCreateSpec
...
func (o DesktopPoolStorageSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *DesktopPoolStorageSettingsCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varDesktopPoolStorageSettingsCreateSpec := _DesktopPoolStorageSettingsCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDesktopPoolStorageSettingsCreateSpec)

	if err != nil {
		return err
	}

	*o = DesktopPoolStorageSettingsCreateSpec(varDesktopPoolStorageSettingsCreateSpec)
