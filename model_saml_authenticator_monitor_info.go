...
// checks if the SAMLAuthenticatorMonitorInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SAMLAuthenticatorMonitorInfo{}
...
func (o SAMLAuthenticatorMonitorInfo) ToMap() (map[string]interface{}, error) {
