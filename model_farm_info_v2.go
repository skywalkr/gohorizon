...
// checks if the FarmInfoV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmInfoV2{}
...
func (o FarmInfoV2) ToMap() (map[string]interface{}, error) {
