...
// checks if the VCMonitorHost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VCMonitorHost{}
...
func (o VCMonitorHost) ToMap() (map[string]interface{}, error) {
