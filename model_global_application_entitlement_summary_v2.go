...
// checks if the GlobalApplicationEntitlementSummaryV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalApplicationEntitlementSummaryV2{}

// GlobalApplicationEntitlementSummaryV2 Summary Information about Global Application Entitlement. <br>Supported Filters : 'And', 'Or', 'Equals', 'StartsWith', 'Contains' and 'EndsWith'.<br>See the field description to know the filter types it supports.
...
func (o GlobalApplicationEntitlementSummaryV2) ToMap() (map[string]interface{}, error) {
