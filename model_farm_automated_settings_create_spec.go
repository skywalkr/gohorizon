...
// checks if the FarmAutomatedSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmAutomatedSettingsCreateSpec{}
...
type _FarmAutomatedSettingsCreateSpec FarmAutomatedSettingsCreateSpec
...
func (o FarmAutomatedSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *FarmAutomatedSettingsCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmAutomatedSettingsCreateSpec := _FarmAutomatedSettingsCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmAutomatedSettingsCreateSpec)

	if err != nil {
		return err
	}

	*o = FarmAutomatedSettingsCreateSpec(varFarmAutomatedSettingsCreateSpec)
