...
// checks if the DesktopPoolDatastoreSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolDatastoreSettings{}
...
func (o *DesktopPoolDatastoreSettings) GetStorageOvercommit() string {
	if o == nil || IsNil(o.StorageOvercommit) {
		var ret string
		return ret
	}
...
func (o DesktopPoolDatastoreSettings) ToMap() (map[string]interface{}, error) {
