...
// checks if the DesktopPoolSessionSettingsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolSessionSettingsV2{}
...
func (o DesktopPoolSessionSettingsV2) ToMap() (map[string]interface{}, error) {
