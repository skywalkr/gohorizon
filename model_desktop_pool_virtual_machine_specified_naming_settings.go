...
// checks if the DesktopPoolVirtualMachineSpecifiedNamingSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolVirtualMachineSpecifiedNamingSettings{}
...
func (o DesktopPoolVirtualMachineSpecifiedNamingSettings) ToMap() (map[string]interface{}, error) {
