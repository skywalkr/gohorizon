...
// checks if the ADUserOrGroupSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADUserOrGroupSummary{}
...
func (o ADUserOrGroupSummary) ToMap() (map[string]interface{}, error) {
