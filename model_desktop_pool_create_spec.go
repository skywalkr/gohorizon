...
// checks if the DesktopPoolCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolCreateSpec{}
...
type _DesktopPoolCreateSpec DesktopPoolCreateSpec
...
func (o DesktopPoolCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *DesktopPoolCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varDesktopPoolCreateSpec := _DesktopPoolCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDesktopPoolCreateSpec)

	if err != nil {
		return err
	}

	*o = DesktopPoolCreateSpec(varDesktopPoolCreateSpec)
