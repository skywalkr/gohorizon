...
func (o DesktopPoolInfoV2) MarshalJSON() ([]byte, error) {
...
func (o DesktopPoolInfoV2) ToMap() (map[string]interface{}, error) {
...
type NullableDesktopPoolInfoV2 struct {
	value *DesktopPoolInfoV2
	isSet bool
}

func (v NullableDesktopPoolInfoV2) Get() *DesktopPoolInfoV2 {
	return v.value
}

func (v *NullableDesktopPoolInfoV2) Set(val *DesktopPoolInfoV2) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopPoolInfoV2) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopPoolInfoV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopPoolInfoV2(val *DesktopPoolInfoV2) *NullableDesktopPoolInfoV2 {
	return &NullableDesktopPoolInfoV2{value: val, isSet: true}
}

func (v NullableDesktopPoolInfoV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopPoolInfoV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
