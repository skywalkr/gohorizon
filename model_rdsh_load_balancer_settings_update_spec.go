...
// checks if the RDSHLoadBalancerSettingsUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RDSHLoadBalancerSettingsUpdateSpec{}
...
type _RDSHLoadBalancerSettingsUpdateSpec RDSHLoadBalancerSettingsUpdateSpec
...
func (o RDSHLoadBalancerSettingsUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *RDSHLoadBalancerSettingsUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varRDSHLoadBalancerSettingsUpdateSpec := _RDSHLoadBalancerSettingsUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRDSHLoadBalancerSettingsUpdateSpec)

	if err != nil {
		return err
	}

	*o = RDSHLoadBalancerSettingsUpdateSpec(varRDSHLoadBalancerSettingsUpdateSpec)
