...
// checks if the NetworkLabelAssignmentSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkLabelAssignmentSettingsInfo{}
...
func (o NetworkLabelAssignmentSettingsInfo) ToMap() (map[string]interface{}, error) {
