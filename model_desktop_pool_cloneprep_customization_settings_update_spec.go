...
// checks if the DesktopPoolCloneprepCustomizationSettingsUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolCloneprepCustomizationSettingsUpdateSpec{}

// DesktopPoolCloneprepCustomizationSettingsUpdateSpec Settings for CLONE_PREP customization for Instant Clone desktop pool.
type DesktopPoolCloneprepCustomizationSettingsUpdateSpec struct {
...
func NewDesktopPoolCloneprepCustomizationSettingsUpdateSpec() *DesktopPoolCloneprepCustomizationSettingsUpdateSpec {
	this := DesktopPoolCloneprepCustomizationSettingsUpdateSpec{}
	return &this
}
...
func (o DesktopPoolCloneprepCustomizationSettingsUpdateSpec) MarshalJSON() ([]byte, error) {
...
func (o DesktopPoolCloneprepCustomizationSettingsUpdateSpec) ToMap() (map[string]interface{}, error) {
...
type NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec struct {
	value *DesktopPoolCloneprepCustomizationSettingsUpdateSpec
	isSet bool
}

func (v NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec) Get() *DesktopPoolCloneprepCustomizationSettingsUpdateSpec {
	return v.value
}

func (v *NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec) Set(val *DesktopPoolCloneprepCustomizationSettingsUpdateSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec(val *DesktopPoolCloneprepCustomizationSettingsUpdateSpec) *NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec {
	return &NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec{value: val, isSet: true}
}

func (v NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopPoolCloneprepCustomizationSettingsUpdateSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
