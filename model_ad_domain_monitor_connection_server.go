...
// checks if the ADDomainMonitorConnectionServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADDomainMonitorConnectionServer{}
...
func (o ADDomainMonitorConnectionServer) ToMap() (map[string]interface{}, error) {
