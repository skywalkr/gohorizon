...
// checks if the LoadBalancerMetricSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoadBalancerMetricSettings{}
...
func (o LoadBalancerMetricSettings) ToMap() (map[string]interface{}, error) {
