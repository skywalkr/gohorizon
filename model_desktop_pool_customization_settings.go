...
// checks if the DesktopPoolCustomizationSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolCustomizationSettings{}

// DesktopPoolCustomizationSettings Customization settings.
type DesktopPoolCustomizationSettings struct {
	// Applicable To: Full/instant clone automated desktop pools.<br>Full clone and Instant Clone Engine Active Directory container for SysPrep and ClonePrep.
	...
	// Applicable To: Instant clone and Full clone desktop pools.<br>Instant clone or full clone domain account. This is the administrator which will add the machines to its domain upon creation.
...
func (o *DesktopPoolCustomizationSettings) GetQuickprepCustomizationSettings() DesktopPoolQuickprepCustomizationSettings {
	if o == nil || IsNil(o.QuickprepCustomizationSettings) {
...
func (o *DesktopPoolCustomizationSettings) GetViewComposerDomainAccountId() string {
	if o == nil || IsNil(o.ViewComposerDomainAccountId) {
		var ret string
		return ret
	}
...
func (o DesktopPoolCustomizationSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QuickprepCustomizationSettings) {
	...
	if !IsNil(o.ViewComposerDomainAccountId) {
