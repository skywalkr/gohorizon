...
// checks if the RDSHLoadBalancerSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RDSHLoadBalancerSettingsCreateSpec{}

// RDSHLoadBalancerSettingsCreateSpec RDSH load balancer settings for the farm.
type RDSHLoadBalancerSettingsCreateSpec struct {
...
func NewRDSHLoadBalancerSettingsCreateSpec() *RDSHLoadBalancerSettingsCreateSpec {
	this := RDSHLoadBalancerSettingsCreateSpec{}
	return &this
}
...
func (o RDSHLoadBalancerSettingsCreateSpec) MarshalJSON() ([]byte, error) {
...
func (o RDSHLoadBalancerSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
...
type NullableRDSHLoadBalancerSettingsCreateSpec struct {
	value *RDSHLoadBalancerSettingsCreateSpec
	isSet bool
}

func (v NullableRDSHLoadBalancerSettingsCreateSpec) Get() *RDSHLoadBalancerSettingsCreateSpec {
	return v.value
}

func (v *NullableRDSHLoadBalancerSettingsCreateSpec) Set(val *RDSHLoadBalancerSettingsCreateSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableRDSHLoadBalancerSettingsCreateSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableRDSHLoadBalancerSettingsCreateSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRDSHLoadBalancerSettingsCreateSpec(val *RDSHLoadBalancerSettingsCreateSpec) *NullableRDSHLoadBalancerSettingsCreateSpec {
	return &NullableRDSHLoadBalancerSettingsCreateSpec{value: val, isSet: true}
}

func (v NullableRDSHLoadBalancerSettingsCreateSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRDSHLoadBalancerSettingsCreateSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
