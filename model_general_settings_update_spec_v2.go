...
// checks if the GeneralSettingsUpdateSpecV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeneralSettingsUpdateSpecV2{}

// GeneralSettingsUpdateSpecV2 Information related to General Settings.
type GeneralSettingsUpdateSpecV2 struct {
...
type _GeneralSettingsUpdateSpecV2 GeneralSettingsUpdateSpecV2
...
func NewGeneralSettingsUpdateSpecV2(applicationSsoTimeoutPolicy string, clientIdleSessionTimeoutPolicy string, clientMaxSessionTimeoutPolicy string, clientSessionTimeoutMinutes int32, machineSsoTimeoutPolicy string, storeCalOnClient bool, storeCalOnConnectionServer bool) *GeneralSettingsUpdateSpecV2 {
	this := GeneralSettingsUpdateSpecV2{}
...
func (o GeneralSettingsUpdateSpecV2) MarshalJSON() ([]byte, error) {
...
func (o GeneralSettingsUpdateSpecV2) ToMap() (map[string]interface{}, error) {
...
func (o *GeneralSettingsUpdateSpecV2) UnmarshalJSON(data []byte) (err error) {
	...
	varGeneralSettingsUpdateSpecV2 := _GeneralSettingsUpdateSpecV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGeneralSettingsUpdateSpecV2)

	if err != nil {
		return err
	}

	*o = GeneralSettingsUpdateSpecV2(varGeneralSettingsUpdateSpecV2)

	return err
}

type NullableGeneralSettingsUpdateSpecV2 struct {
	value *GeneralSettingsUpdateSpecV2
	isSet bool
}

func (v NullableGeneralSettingsUpdateSpecV2) Get() *GeneralSettingsUpdateSpecV2 {
	return v.value
}

func (v *NullableGeneralSettingsUpdateSpecV2) Set(val *GeneralSettingsUpdateSpecV2) {
	v.value = val
	v.isSet = true
}

func (v NullableGeneralSettingsUpdateSpecV2) IsSet() bool {
	return v.isSet
}

func (v *NullableGeneralSettingsUpdateSpecV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeneralSettingsUpdateSpecV2(val *GeneralSettingsUpdateSpecV2) *NullableGeneralSettingsUpdateSpecV2 {
	return &NullableGeneralSettingsUpdateSpecV2{value: val, isSet: true}
}

func (v NullableGeneralSettingsUpdateSpecV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeneralSettingsUpdateSpecV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
