...
// checks if the FarmDatastoreSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmDatastoreSettingsInfo{}
...
func (o FarmDatastoreSettingsInfo) ToMap() (map[string]interface{}, error) {
