...
// checks if the TrueSSOMonitorInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrueSSOMonitorInfo{}
...
type TrueSSOMonitorInfo struct {
	...
	AdDomainDnsName *string `json:"ad_domain_dns_name,omitempty"`
	...
	AdDomainStatus *string `json:"ad_domain_status,omitempty"`
	// Details of each certificate server.
	CertificateServerDetails []CertificateServerDetails `json:"certificate_server_details,omitempty"`
	...
	PrimaryEnrollmentServer *EnrollmentServerDetails `json:"primary_enrollment_server,omitempty"`
...
// GetAdDomainDnsName returns the AdDomainDnsName field value if set, zero value otherwise.
func (o *TrueSSOMonitorInfo) GetAdDomainDnsName() string {
	if o == nil || IsNil(o.AdDomainDnsName) {
		var ret string
		return ret
	}
...
// GetAdDomainDnsNameOk returns a tuple with the AdDomainDnsName field value if set, nil otherwise
...
// SetAdDomainDnsName gets a reference to the given string and assigns it to the AdDomainDnsName field.
...
// GetAdDomainStatus returns the AdDomainStatus field value if set, zero value otherwise.
func (o *TrueSSOMonitorInfo) GetAdDomainStatus() string {
	if o == nil || IsNil(o.AdDomainStatus) {
		var ret string
		return ret
	}
...
// GetAdDomainStatusOk returns a tuple with the AdDomainStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAdDomainStatus gets a reference to the given string and assigns it to the AdDomainStatus field.
func (o *TrueSSOMonitorInfo) SetAdDomainStatus(v string) {
	o.AdDomainStatus = &v
}

// GetCertificateServerDetails returns the CertificateServerDetails field value if set, zero value otherwise.
func (o *TrueSSOMonitorInfo) GetCertificateServerDetails() []CertificateServerDetails {
	if o == nil || IsNil(o.CertificateServerDetails) {
...
// GetCertificateServerDetailsOk returns a tuple with the CertificateServerDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCertificateServerDetails gets a reference to the given []CertificateServerDetails and assigns it to the CertificateServerDetails field.
...
// GetPrimaryEnrollmentServer returns the PrimaryEnrollmentServer field value if set, zero value otherwise.
func (o *TrueSSOMonitorInfo) GetPrimaryEnrollmentServer() EnrollmentServerDetails {
	if o == nil || IsNil(o.PrimaryEnrollmentServer) {
...
// GetPrimaryEnrollmentServerOk returns a tuple with the PrimaryEnrollmentServer field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPrimaryEnrollmentServer gets a reference to the given EnrollmentServerDetails and assigns it to the PrimaryEnrollmentServer field.
...
func (o *TrueSSOMonitorInfo) GetSecondaryEnrollmentServer() EnrollmentServerDetails {
	if o == nil || IsNil(o.SecondaryEnrollmentServer) {
		var ret EnrollmentServerDetails
		return ret
	}
...
func (o TrueSSOMonitorInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AdDomainDnsName) {
		toSerialize["ad_domain_dns_name"] = o.AdDomainDnsName
	}
	if !IsNil(o.AdDomainId) {
		toSerialize["ad_domain_id"] = o.AdDomainId
	}
	if !IsNil(o.AdDomainStatus) {
		toSerialize["ad_domain_status"] = o.AdDomainStatus
	}
	if !IsNil(o.CertificateServerDetails) {
	...
	if !IsNil(o.PrimaryEnrollmentServer) {
		toSerialize["primary_enrollment_server"] = o.PrimaryEnrollmentServer
	}
	if !IsNil(o.SecondaryEnrollmentServer) {
