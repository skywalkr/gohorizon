...
// checks if the DesktopPoolSessionSettingsV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolSessionSettingsV3{}

// DesktopPoolSessionSettingsV3 Machine settings applicable when a user logs off or when a desktop pool is no longer keeping a machine as a spare.
type DesktopPoolSessionSettingsV3 struct {
...
func NewDesktopPoolSessionSettingsV3() *DesktopPoolSessionSettingsV3 {
	this := DesktopPoolSessionSettingsV3{}
	return &this
}
...
func (o DesktopPoolSessionSettingsV3) MarshalJSON() ([]byte, error) {
...
func (o DesktopPoolSessionSettingsV3) ToMap() (map[string]interface{}, error) {
...
type NullableDesktopPoolSessionSettingsV3 struct {
	value *DesktopPoolSessionSettingsV3
	isSet bool
}

func (v NullableDesktopPoolSessionSettingsV3) Get() *DesktopPoolSessionSettingsV3 {
	return v.value
}

func (v *NullableDesktopPoolSessionSettingsV3) Set(val *DesktopPoolSessionSettingsV3) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopPoolSessionSettingsV3) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopPoolSessionSettingsV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopPoolSessionSettingsV3(val *DesktopPoolSessionSettingsV3) *NullableDesktopPoolSessionSettingsV3 {
	return &NullableDesktopPoolSessionSettingsV3{value: val, isSet: true}
}

func (v NullableDesktopPoolSessionSettingsV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopPoolSessionSettingsV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
