...
// checks if the PodEndPointData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PodEndPointData{}
...
func (o PodEndPointData) ToMap() (map[string]interface{}, error) {
