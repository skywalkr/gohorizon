...
// checks if the ADDomainAdvancedSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADDomainAdvancedSettings{}
...
type _ADDomainAdvancedSettings ADDomainAdvancedSettings
...
func (o ADDomainAdvancedSettings) ToMap() (map[string]interface{}, error) {
...
func (o *ADDomainAdvancedSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varADDomainAdvancedSettings := _ADDomainAdvancedSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varADDomainAdvancedSettings)

	if err != nil {
		return err
	}

	*o = ADDomainAdvancedSettings(varADDomainAdvancedSettings)
