...
// checks if the PhysicalMachineInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalMachineInfo{}
...
func (o PhysicalMachineInfo) ToMap() (map[string]interface{}, error) {
