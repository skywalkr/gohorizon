...
// checks if the VCMonitorHostDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VCMonitorHostDetails{}
...
func (o VCMonitorHostDetails) ToMap() (map[string]interface{}, error) {
