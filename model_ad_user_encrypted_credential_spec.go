...
// checks if the ADUserEncryptedCredentialSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADUserEncryptedCredentialSpec{}
...
type _ADUserEncryptedCredentialSpec ADUserEncryptedCredentialSpec
...
func (o ADUserEncryptedCredentialSpec) ToMap() (map[string]interface{}, error) {
...
func (o *ADUserEncryptedCredentialSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varADUserEncryptedCredentialSpec := _ADUserEncryptedCredentialSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varADUserEncryptedCredentialSpec)

	if err != nil {
		return err
	}

	*o = ADUserEncryptedCredentialSpec(varADUserEncryptedCredentialSpec)
