...
// checks if the FarmDisplayProtocolSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmDisplayProtocolSettings{}
...
func (o *FarmDisplayProtocolSettings) GetAllowDisplayProtocolOverride() bool {
	if o == nil || IsNil(o.AllowDisplayProtocolOverride) {
		var ret bool
		return ret
	}
...
func (o FarmDisplayProtocolSettings) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AllowDisplayProtocolOverride) {
