...
// checks if the FarmCloneprepCustomizationSettingsUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmCloneprepCustomizationSettingsUpdateSpec{}
...
func (o FarmCloneprepCustomizationSettingsUpdateSpec) ToMap() (map[string]interface{}, error) {
