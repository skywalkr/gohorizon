...
// checks if the ConnectionServerMonitorInfoV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionServerMonitorInfoV2{}
...
func (o ConnectionServerMonitorInfoV2) ToMap() (map[string]interface{}, error) {
