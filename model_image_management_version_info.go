...
// checks if the ImageManagementVersionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageManagementVersionInfo{}
...
func (o ImageManagementVersionInfo) ToMap() (map[string]interface{}, error) {
