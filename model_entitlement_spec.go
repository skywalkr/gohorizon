...
// checks if the EntitlementSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementSpec{}
...
func (o EntitlementSpec) ToMap() (map[string]interface{}, error) {
