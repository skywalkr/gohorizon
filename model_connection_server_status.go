...
// checks if the ConnectionServerStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionServerStatus{}
...
func (o *ConnectionServerStatus) GetPendingPercentage() int32 {
	if o == nil || IsNil(o.PendingPercentage) {
		var ret int32
		return ret
	}
...
func (o ConnectionServerStatus) ToMap() (map[string]interface{}, error) {
