...
// checks if the NetworkLabelInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkLabelInfo{}
...
func (o NetworkLabelInfo) ToMap() (map[string]interface{}, error) {
