...
// checks if the MachineSpecifiedName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MachineSpecifiedName{}
...
type _MachineSpecifiedName MachineSpecifiedName
...
func (o MachineSpecifiedName) ToMap() (map[string]interface{}, error) {
...
func (o *MachineSpecifiedName) UnmarshalJSON(data []byte) (err error) {
	...
	varMachineSpecifiedName := _MachineSpecifiedName{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMachineSpecifiedName)

	if err != nil {
		return err
	}

	*o = MachineSpecifiedName(varMachineSpecifiedName)
