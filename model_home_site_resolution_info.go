...
// checks if the HomeSiteResolutionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HomeSiteResolutionInfo{}
...
func (o *HomeSiteResolutionInfo) GetResolutionData() []HomeSiteResolutionData {
	if o == nil || IsNil(o.ResolutionData) {
...
func (o HomeSiteResolutionInfo) ToMap() (map[string]interface{}, error) {
