...
// checks if the FarmCustomizationSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmCustomizationSettingsInfo{}
...
func (o FarmCustomizationSettingsInfo) ToMap() (map[string]interface{}, error) {
