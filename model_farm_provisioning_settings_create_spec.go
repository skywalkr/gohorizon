...
// checks if the FarmProvisioningSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmProvisioningSettingsCreateSpec{}
...
type _FarmProvisioningSettingsCreateSpec FarmProvisioningSettingsCreateSpec
...
func (o FarmProvisioningSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *FarmProvisioningSettingsCreateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varFarmProvisioningSettingsCreateSpec := _FarmProvisioningSettingsCreateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFarmProvisioningSettingsCreateSpec)

	if err != nil {
		return err
	}

	*o = FarmProvisioningSettingsCreateSpec(varFarmProvisioningSettingsCreateSpec)
