...
// checks if the FarmInfoV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmInfoV3{}
...
func (o FarmInfoV3) ToMap() (map[string]interface{}, error) {
