...
// checks if the ADDomainMonitorInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADDomainMonitorInfo{}
...
func (o ADDomainMonitorInfo) ToMap() (map[string]interface{}, error) {
