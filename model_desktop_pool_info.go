...
// checks if the DesktopPoolInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolInfo{}
...
func (o DesktopPoolInfo) ToMap() (map[string]interface{}, error) {
