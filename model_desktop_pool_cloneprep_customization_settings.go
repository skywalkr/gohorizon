...
// checks if the DesktopPoolCloneprepCustomizationSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopPoolCloneprepCustomizationSettings{}
...
func (o DesktopPoolCloneprepCustomizationSettings) ToMap() (map[string]interface{}, error) {
