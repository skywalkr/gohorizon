...
// checks if the FarmDisplayProtocolSettingsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmDisplayProtocolSettingsInfo{}
...
func (o FarmDisplayProtocolSettingsInfo) ToMap() (map[string]interface{}, error) {
