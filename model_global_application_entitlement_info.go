...
// checks if the GlobalApplicationEntitlementInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalApplicationEntitlementInfo{}
...
func (o GlobalApplicationEntitlementInfo) ToMap() (map[string]interface{}, error) {
