...
// checks if the FarmDisplayProtocolSettingsCreateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FarmDisplayProtocolSettingsCreateSpec{}
...
func (o FarmDisplayProtocolSettingsCreateSpec) ToMap() (map[string]interface{}, error) {
