...
func (o *PodInfo) GetActiveGlobalApplicationEntitlements() []string {
	if o == nil || IsNil(o.ActiveGlobalApplicationEntitlements) {
		var ret []string
		return ret
	}
...
func (o *PodInfo) GetActiveGlobalDesktopEntitlements() []string {
	if o == nil || IsNil(o.ActiveGlobalDesktopEntitlements) {
		var ret []string
		return ret
	}
...
func (o PodInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ActiveGlobalApplicationEntitlements) {
		toSerialize["active_global_application_entitlements"] = o.ActiveGlobalApplicationEntitlements
	}
	if !IsNil(o.ActiveGlobalDesktopEntitlements) {
