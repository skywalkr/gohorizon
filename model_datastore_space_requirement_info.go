...
// checks if the DatastoreSpaceRequirementInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatastoreSpaceRequirementInfo{}
...
func (o *DatastoreSpaceRequirementInfo) GetMaxSizeDiskGb() float64 {
	if o == nil || IsNil(o.MaxSizeDiskGb) {
		var ret float64
		return ret
	}
...
func (o *DatastoreSpaceRequirementInfo) GetMidSizeDiskGb() float64 {
	if o == nil || IsNil(o.MidSizeDiskGb) {
		var ret float64
		return ret
	}
...
func (o *DatastoreSpaceRequirementInfo) GetMinSizeDiskGb() float64 {
	if o == nil || IsNil(o.MinSizeDiskGb) {
		var ret float64
		return ret
	}
...
func (o DatastoreSpaceRequirementInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DiskType) {
		toSerialize["disk_type"] = o.DiskType
	}
	if !IsNil(o.MaxSizeDiskGb) {
		toSerialize["max_size_disk_gb"] = o.MaxSizeDiskGb
	}
	if !IsNil(o.MidSizeDiskGb) {
		toSerialize["mid_size_disk_gb"] = o.MidSizeDiskGb
	}
	if !IsNil(o.MinSizeDiskGb) {
