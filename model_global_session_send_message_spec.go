...
// checks if the GlobalSessionSendMessageSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalSessionSendMessageSpec{}
...
type _GlobalSessionSendMessageSpec GlobalSessionSendMessageSpec
...
func (o GlobalSessionSendMessageSpec) ToMap() (map[string]interface{}, error) {
...
func (o *GlobalSessionSendMessageSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalSessionSendMessageSpec := _GlobalSessionSendMessageSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGlobalSessionSendMessageSpec)

	if err != nil {
		return err
	}

	*o = GlobalSessionSendMessageSpec(varGlobalSessionSendMessageSpec)
